...
int main(int argc, char** argv) {
    ...
    // We're trying to detect a bottle or cup placed about 50-70cm from the camera, so we need to remove the background
    // And the flat surface the object is placed on
    ...
    // Then pass the point cloud through a statistical outlier removal filter
    ...
    vfh_model histogram;
    std::string vfh_path = model_directory + "/capture_vfh.pcd";
